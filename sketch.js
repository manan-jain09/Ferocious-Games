...
var cloudsGroup, cloudImage, dinos, dino, dinoS, dinosGroup;
...
function preload(){
  ...
  dinos = loadAnimation("dino.png", "dino1.png", "dino2.png", "dino3.png", "dino4.png", "dino5.png", "dino6.png", "dino7.png");
  dinoS = loadAnimation("dinoS.png");
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    if((keyDown("space") || keyDown(UP_ARROW)) && trex.y >= 152) {
      trex.velocityY = -10;
      jumpSound.play();
    }
    ...
    dino.changeAnimation("dinoS",dinoS);
...
function spawnDinos() {
  //write code here to spawn the clouds
  if (frameCount % 99 === 0) {
    dino = createSprite(600,100,40,10);
    dino.y = Math.round(random(100,140));
    dino.velocityX = -(6 + score / 100);
    dino.addAnimation("dinos",dinos);
    dino.addAnimation("dinoS",dinoS);
    dino.scale = 0.2;
